...
const GroupTask: React.FC = () => {
    ...
    const handleAssignTasks = () => {
        // Filter tasks that are unassigned (assigned_to is null or undefined)
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-100">
                                        <tr>
                                            ...
                                            <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                Assigned To {/* Added Assigned To Header */}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {tasks
                                            ...
                                            .map((task) => (
                                                <tr key={task.task_id}> {/* Changed key to task_id */}
                                                    <td className="px-4 py-2">{task.task_name}</td>
                                                    <td className="px-4 py-2">
                                                        {new Date(task.due_date).toLocaleDateString()}
                                                    </td>
                                                    <td className="px-4 py-2">{task.taskSkillLevel}</td>
                                                    <td className="px-4 py-2">{task.status}</td> {/* Display Task Status */}
                                                    <td className="px-4 py-2 text-gray-500">Unassigned</td> {/* Display "Unassigned" */}
                                                </tr>
                                            ))}
                                    </tbody>
                                </table>
                                        ...
                                        {tasks
                                            ...
                                            .map((task) => (
                                                <tr key={task.task_id}> {/* Changed key to task_id */}
                                                    ...
                                                    <td className="px-4 py-2">{task.taskSkillLevel}</td>
                                                    <td className="px-4 py-2">{task.status}</td> {/* Display Task Status */}
                                                    <td className="px-4 py-2 text-gray-900">{task.assigned_to}</td> {/* Display Assigned User ID */}
                                                </tr>
                                            ))}
                                    </tbody>
                                </table>
